...
extension TransactionModelQueryWhereSort
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhere> anyCategory() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByMessage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> messageProperty() {
    return QueryBuilder.apply(this, (query) {
